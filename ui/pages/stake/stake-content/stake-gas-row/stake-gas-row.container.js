...
import StakeGasRow from './stake-gas-row.component'

export default connect(mapStateToProps, mapDispatchToProps, mergeProps)(StakeGasRow)
...
function mapStateToProps (state) {
  ...
  const insufficientBalance = !isBalanceSufficient({ // TODO: improve this detection
    amount: getSendAsset(state) ? '0x0' : getSendAmount(state),
    gasTotal,
    balance,
    conversionRate,
  })
