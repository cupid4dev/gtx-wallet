...
const MODALS = {
  ...
  GAS_MAX_FEE_INFO_MODAL: {
    contents: <NotifcationModal header="gasMaxFee" message="gasMaxFeeInfoModalContent" />,
    mobileModalStyle: {
      width: '95%',
      top: getEnvironmentType() === ENVIRONMENT_TYPE_POPUP ? '52vh' : '36.5vh',
    },
  ...
  GAS_PRIORITY_FEE_INFO_MODAL: {
    contents: <NotifcationModal header="gasPriorityFee" message="gasPriorityFeeInfoModalContent" />,
    mobileModalStyle: {
      width: '95%',
      top: getEnvironmentType() === ENVIRONMENT_TYPE_POPUP ? '52vh' : '36.5vh',
    },
