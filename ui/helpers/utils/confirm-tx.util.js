...
export function increaseLastGasPriceParams (lastGasPriceParams) {
  if (lastGasPriceParams.maxFeePerGas) {
    return {
      maxFeePerGas: increaseLastGasPrice(lastGasPriceParams.maxFeePerGas),
      maxPriorityFeePerGas: increaseLastGasPrice(lastGasPriceParams.maxPriorityFeePerGas),
    }
  }
  return {
    gasPrice: increaseLastGasPrice(lastGasPriceParams.gasPrice),
  }
}
