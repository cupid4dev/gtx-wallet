...
const NFT_ROUTE = '/nft'
const STAKE_ROUTE = '/stake'
const STAKE_ASSET_ROUTE = '/stake-asset'
...
const WRAP_ASSET_ROUTE = '/wrap-asset'
const WRAP_ROUTE = '/wrap'
...
const CONFIRM_WRAP_TOKEN_PATH = '/wrap-unwrap'
...
const CONFIRM_STAKE_PATH = '/stake'
const CONFIRM_UNSTAKE_PATH = '/unstake'
