...
* Load older version of GTx Wallet and attempt to simulate updating the extension.
...
* Token Management
    ...
    * Send that token to another GTx Wallet address.
...
* Ganache set blocktime to simulate retryTx in GTx Wallet
