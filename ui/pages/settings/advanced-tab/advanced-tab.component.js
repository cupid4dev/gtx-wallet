...
export default class AdvancedTab extends PureComponent {
  ...
  renderBackup () {
    ...
    return (
      <div className="settings-page__content-row" data-testid="advanced-setting-backup-data">
        <div className="settings-page__content-item">
  ...
  renderRestore () {
    ...
    return (
      <div className="settings-page__content-row" data-testid="advanced-setting-restore-data">
        <div className="settings-page__content-item">
