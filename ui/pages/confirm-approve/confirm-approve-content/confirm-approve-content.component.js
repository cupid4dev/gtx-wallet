...
export default class ConfirmApproveContent extends Component {
  ...
  renderPermissionContent () {
    ...
    if (isInternal) {
      const stakeToken = Object.values(thetaTokens).find(({ address }) => address?.toLowerCase() === toAddress)
      if (stakeToken?.name) {
    ...
    return (
      <div className="flex-column">
        <div className="confirm-approve-content__small-text">{ t('accessAndSpendNotice', [useOrigin]) }</div>
