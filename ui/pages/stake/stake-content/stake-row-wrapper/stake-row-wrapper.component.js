...
import StakeRowErrorMessage from './stake-row-error-message'

export default class StakeRowWrapper extends Component {
    ...
    return (
      <div className="wrap-v2__form-row">
        ...
        <div className="wrap-v2__form-field-container">
          <div className="wrap-v2__form-field">
            {formField}
          </div>
          <div>
            {showError && <StakeRowErrorMessage errorType={errorType} />}
          </div>
        </div>
      </div>
    )
  ...
  renderFormRow () {
    ...
    return (
      <div className="wrap-v2__form-row stake-row">
        <div className="wrap-v2__form-label">
          {label}
          {showError && <StakeRowErrorMessage errorType={errorType} />}
          {customLabelContent}
