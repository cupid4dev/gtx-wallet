...
class ConfirmTxScreen extends Component {
  ...
  componentDidMount () {
    ...
    const unconfTxList = txHelper(unapprovedTxs, undefined, undefined, undefined, undefined, undefined, network, chainId, selectedNative)
  ...
  componentDidUpdate (prevProps) {
    ...
    if (transactionId) {
      ...
      const prevUnconfTxList = txHelper(prevUnapprovedTxs, undefined, undefined, undefined, undefined, undefined, network, chainId, selectedNative)
