...
export function getToWarningObject (to, tokens = [], sendAsset = null) {
  let toWarning = null
  if (sendAsset?.address && (ethUtil.toChecksumAddress(to) in contractMap || checkExistingAddresses(to, tokens))) {
