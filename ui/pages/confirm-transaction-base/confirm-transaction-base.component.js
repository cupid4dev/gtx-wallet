...
import { ETH_SYMBOL, MAINNET_NETWORK_ID, TFUEL_SYMBOL, THETAMAINNET_NETWORK_ID, THETA_SYMBOL } from '../../../app/scripts/controllers/network/enums'
...
export default class ConfirmTransactionBase extends Component {
        ...
        <div className="confirm-page-container-content__details">
          <div className="confirm-page-container-content__gas-fee">
            <ConfirmDetailRow
              ...
              onHeaderClick={typeof txData.txParams?.additional?.purpose !== 'undefined' || notMainnetOrTest
                ? undefined
                : () => this.handleEditGas()
              }
              secondaryText={showFiatForGas ? '' : this.context.t('noConversionRateAvailable') }
            />
            {advancedInlineGasShown || notMainnetOrTest
              ? (
                <AdvancedGasInputs
                  updateCustomGasPriceParams={(newGasPriceParams) => updateGasAndCalculate({ ...customGas, ...newGasPriceParams })}
          ...
          <div className={useNonceField ? 'confirm-page-container-content__gas-fee' : null}>
            <ConfirmDetailRow
              ...
              secondaryText={hideFiatConversion || hasTheta ? this.context.t('noConversionRateAvailable') : secondaryTotalTextOverride}
  ...
  renderTitleComponent () {
    const { title, titleComponent, hexTransactionAmount, hexTransactionAmount2, txData } = this.props
    ...
    if (txData.txParams.value2) {
      ...
      suffix = (txData.metamaskNetworkId === MAINNET_NETWORK_ID ? ETH_SYMBOL : undefined)
    }
  ...
  renderSubtitleComponent () {
    const { subtitle, subtitleComponent, hexTransactionAmount, hexTransactionAmount2 } = this.props
  ...
  render () {
    ...
    if (!functionType || !functionType.length) {
      if (typeEx) {
        ...
        actionLabel = getTransactionTypeTitle(t, typeEx, txData.txParams?.additional)
      } else {
