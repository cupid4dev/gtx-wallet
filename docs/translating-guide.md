# GTx Wallet Translation Guide

The GTx Wallet browser extension supports new translations added in the form of new locales files added in `app/_locales`.
...
- Add the language to the [locales index](https://github.com/TheGworld/GTx-wallet/blob/master/app/_locales/index.json) `app/_locales/index.json` 


That's it! When GTx Wallet is loaded on a computer with that language set as the system language, they will see your translation instead of the default one.
...
To verify that your translation works in the app, you will need to [build a local copy](https://github.com/TheGworld/GTx-wallet#building-locally) of GTx Wallet. You will need to change your browser language, your operating system language, and restart your browser (sorry it's so much work!).
