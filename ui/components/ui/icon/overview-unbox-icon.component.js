...
export default function UnboxIcon ({
  width = '22',
  height = '22',
  fill = 'none',
  stroke = '#037dd6',
    ...
    >
      ...
      >
        ...
        <path
          id="left-arrow-head"
          style={styleArrow}
          d="M 58.208333,138.5042 55.5625,141.15004 Z"
        />
        <path
          id="right-arrow-head"
          style={styleArrow}
          d="m 58.208333,138.5042 2.645834,2.64584 z"
        />
        <path
          id="arrow-shaft"
          style={styleArrow}
          d="m 58.208333,138.5042 v 13.22917 z"
        />
        <path
          id="left-flap"
          style={styleFlaps}
